...
from model_no_scene import TrajectoryGenerator
...
parser.add_argument('--model_path', default="C:/Users/arsal/PycharmProjects/SGAN-AE-master/SGAN-AE-master/checkpoint_with_model.pt",type=str)
    ...
    with torch.no_grad():
        for batch in loader:
            ...
            for _ in range(num_samples):
                ...
                trajs.append([obs_traj.cpu().numpy(), pred_traj_fake.cpu().numpy(), pred_traj_gt.cpu().numpy(),
...
def main(args):
    ...
    for path in paths:
        ...
        with open("trajs_dumped/" + args.model_path.split("/")[-1].split(".")[0] + "_" + args.dset_type + "_trajs.pkl",
                  'wb+') as f:
            pickle.dump(trajs, f)

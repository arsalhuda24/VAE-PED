...
#     def __init__(self,img,out,sc_hidden=64):
#         self.scene_embedding = nn.Linear(13824, sc_hidden)
#
...
class TrajectoryGenerator(nn.Module):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, user_noise=None):
        ...
        # print(decoder_h1.shape)
        """ADDED BY ME THE GREAT"""
        # decoder_h = final_encoder_h
